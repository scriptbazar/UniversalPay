...
export default function TermsOfServicePage() {
    return (
        <div>
            <h1 className="text-3xl font-bold text-center">Terms of Service for UniversalPay</h1>
            ...
            <p>When you process a payment through UniversalPay, you are subject to our transaction fees, which will be disclosed at the time of the transaction. All settlements are processed in your chosen cryptocurrency. You are responsible for any network or gas fees associated with withdrawals.</p>
