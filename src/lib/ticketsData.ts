...
let tickets: Ticket[] = [
  ...
  },
  {
    ...
    status: 'In Progress',
    priority: 'Medium',
    createdAt: new Date('2023-11-09T14:30:00Z').toISOString(),
    updatedAt: new Date('2023-11-09T15:00:00Z').toISOString(),
    replies: [
       {
        author: 'Admin',
  ...
  },
   {
    ...
    status: 'Closed',
    priority: 'High',
    createdAt: new Date('2023-11-08T10:00:00Z').toISOString(),
    updatedAt: new Date('2023-11-08T12:05:00Z').toISOString(),
    replies: [
      {
        author: 'Admin',
        message: 'Hi John, it seems there was a caching issue. It should be resolved now. Please try again.',
        createdAt: new Date('2023-11-08T11:00:00Z').toISOString(),
      },
      {
        author: 'John Doe',
        message: 'Yes, it is working now. Thank you!',
        createdAt: new Date('2023-11-08T12:05:00Z').toISOString(),
      },
    ],
  },
];
